			...
			<table id="cart" class="table table-hover table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td data-th="Price">${cartLine.buyingPrice} VND</td>
						<td data-th="Quantity">
				...
				<tfoot>
					<tr class="visible-xs">
						<td class="text-center"><strong>Total ${userModel.cart.grandTotal} VND</strong></td>
					</tr>
					<tr>
						...
						<td class="hidden-xs text-center"><strong>Total ${userModel.cart.grandTotal} VND</strong></td>
